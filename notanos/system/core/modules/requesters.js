(function() {
  ...
  function fileDialog(filename,options,responseCallback) {
		...
		var fileView=sys.modules.fileItem.createItemContainer(win.clientArea,"list");
    ...
    var base = fileView.element;
		var fileView=base.querySelector(".fileview");
		base.element.addClass("requester");
